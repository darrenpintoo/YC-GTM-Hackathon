/**
 * Grounded one-liners for why a person is worth meeting at an event.
 * Shared by enrich (server) and AttendeeList (client fallback).
 */
...
/** True when the AI line just restates role/company without event-specific signal. */
...
/** Pick AI reason when good, otherwise heuristic. */
